...
// export class CompareChallengeProcessEngine extends ProcessEngine<
//   VerifyChallengeInput,
//   VerifyChallengeOutput,
//   Error
// > {
//   public readonly name = "CompareChallengeProcessEngine";
...
//     const localChallenges = await findChallengeByHash(txHash);
//     if (
//       !localChallenges ||
...
//     const localChallenge = localChallenges[0];
