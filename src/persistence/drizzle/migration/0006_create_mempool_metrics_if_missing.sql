...
CREATE INDEX IF NOT EXISTS "idx_mempool_metrics_recorded_at" ON "mempool_metrics" USING btree ("recorded_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_mempool_metrics_version" ON "mempool_metrics" USING btree ("platform_version");
